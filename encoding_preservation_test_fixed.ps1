...
if ($totalAnomalies -lt 100) {
    Write-Host "Anomaly claim FALSE: Only $totalAnomalies anomalies found vs 1180+ claimed" -ForegroundColor Red
} else {
...
Write-Host "- Anomaly count: FALSE (minimal vs 1180+ claimed)"
